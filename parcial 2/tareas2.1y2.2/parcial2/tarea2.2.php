<html>
    <body>
        ...
        <header>
            ...
            <ul id="menu2">
                <li><a class="es" href="letras2.2.php">Problema</a></li> 
        ...
        <div class="descripcion">
            ...
            <table border="1" cellspacing="1"  class="puntos">
                    ...
                    <p>
                        ...
                        , las letras W, S y X reciben el valor 2 y así sucesivamente hasta que las letras O y L reciben el valor 9
                        y la letra P recibe el valor 0. Una palabra formada por estas letras recibe como valor la suma de los valores de las letras que la forman. Por ejemplo, la palabra UAM recibe como valor 
                        7+1+7¡15. Escribe un programa que determine el valor 
                        de una palabra p.
                    </p>
...
<hr>
        <div class="descripcion">
                <h2>11823. Evaluando Una Función Rara</h2>
                ...
                <table border="1" cellspacing="1"  class="puntos">
                        ...
                        <h3>Entrada</h3>
                        <p>
                            Un entero, el valor a utilizar para evaluar f(x).
                        </p>
                        <h3>Salida</h3>
                        <p>
                            El resultado de f(x)
