<html>
    <body>
        ...
        <header>
            ...
            <ul id="menu2">
                <li><a class="es" href="1.6.php">Problema</a></li> 
        ...
        <div class="descripcion">
            ...
            <table border="1" cellspacing="1"  class="puntos">
                    ...
                    <h3>Entrada</h3>
                    <p>
                        En la primera línea el entero N. En la segunda línea, separados por un espacio, 
                        los números del primer conjunto. En la tercera línea también separados por un espacio, 
                        los números del segundo conjunto 
                    </p>
                    <h3>Salida</h3>
                    <p>
                ...
                <table border="1" class="ejemplo">
                    <tr>
                        <td colspan="3">4 <br> 2 3 4 5 <br> 6 7 1 3</td>
                        <td>8 10 5 8</td>
